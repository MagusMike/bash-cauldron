...
Slack.app version is outdated and must be updated. Please Select Update to install the newer version, or quit to postpone.
...
if [ "$userChoice" == "0" ]; then
    ...
    jamf policy -event install-slack 
